<?php
    ...
    // CHECKOUT
    if (isset($_POST['user_cart_selection']) && (! empty($_POST['user_cart_selection']))) {
        $cart_session_value = $_POST['user_cart_selection'];

        $_SESSION['cartValue'] = $cart_session_value;

        header("location: ./checkout/index.php?checkoutID=$pid");
    }
    else {
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <div style="display:flex;flex-direction:row;" class="row">
                                                            <div class="row">
                                                                ...
                                                                <input value="<?php if(! empty($_SESSION['cartValue'])){echo($_SESSION['cartValue']);}?>" style="margin-right:10px;margin-left:10px;width:20%;text-align:center;border:1px solid skyblue;" placeholder="How many?" class="form-control" type="number" name="user_cart_selection">
                                                                ...
                                                                <button type="submit" style="width:30%;" class="text-decoration-none btn btn-sm btn-light btn-outline-primary">Add To Basket</button></form>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
