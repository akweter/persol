<?php
    ...
    if(isset($_POST['Signup'])){
        ...
        $User = "SELECT * FROM `signup` WHERE username = '$Username' OR email = '$eAddress' ";
                ...
                <div class="modal-content p-3 ">
                    ...
                    <div class="modal-body rounded-3  pt-0">
                        <form method="post">
                            ...
                            <hr class="my-4">
                            <div>
                                <h5 style="text-align:center;">Alredy have account?</h5>
                                <a href="./login.php" class="w-100 mb-4 btn btn-md rounded-3 btn-primary"><strong> Login</strong></a>
                            </div>
                        </form>
                    </div>
                </div>
